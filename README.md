# 大数据成神之路
## 声明
文档中参考引用了大量网络上的博客和文章，大部分给出了出去，有些没写，如果造成了侵权行为，请您联系我，立即删除~

## 我是谁？
说起这个可就牛逼了 我 马云前同事 逍遥子的现同事 跟高晓松等人在一个App谈笑风生的男人  额O__O "…~
...
我这里单纯面对数据应用层或者中间件方向，也是大数据方向最有含金量的一个方向(我自己认为的，你不同意就算了，哈哈)~
